...
export const Navbar = ({
  ...
  return (
    <div className="flex flex-col lg:flex-row border-t border-b border-white/10 py-2 justify-between px-4 md:px-5 gap-4 md:gap-0 bg-[#1b103c]" data-testid="navbar">
