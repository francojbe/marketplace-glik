    ...
    >
      ...
      >
        ...
        <div className="p-5 flex flex-col flex-1 group-hover:bg-gray-50/50 transition-colors duration-300">
          ...
          <div className="w-full flex items-center justify-center bg-[#ec7b15] text-white py-3 rounded-lg hover:bg-[#d66a0e] transition-colors font-bold uppercase text-sm tracking-wider shadow-md hover:shadow-lg min-h-[48px]">
            Ver Detalles
          </div>
        </div>
      </LocalizedClientLink>
