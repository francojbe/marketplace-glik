        ...
        <section className="w-full py-8 overflow-x-auto no-scrollbar bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="flex px-4 gap-4 md:gap-6 min-w-max justify-around">
                {MOTO_CATEGORIES.map((cat) => (
                    ...
                    >
                        <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gray-50 flex items-center justify-center text-gray-500 group-hover:bg-[#ec7b15] group-hover:text-white transition-colors shadow-sm ring-1 ring-gray-100">
